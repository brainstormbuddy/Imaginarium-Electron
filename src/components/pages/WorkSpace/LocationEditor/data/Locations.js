export const locations = [
  {
    ...
    location_collaborators_number: "+17",
  },
  {
    location_id: 1,
    location_border_color: "[#2B2B2B]",
    location_name: "body in the pool",
    ...
    location_collaborators_number: "+5",
  },
  {
    location_id: 2,
    location_border_color: "[#2B2B2B]",
    location_name: "statues room",
    ...
    location_collaborators_number: "+6",
  },
  {
    location_id: 3,
    location_border_color: "[#2B2B2B]",
    location_name: "main Kentucky street",
    location_status: "Pending",
    location_images: [
      {
    ...
    location_collaborators_number: "+21",
  },
  {
    location_id: 4,
    location_border_color: "[#2B2B2B]",
    location_name: "Execution",
    location_status: "Unconfirmed",
    location_images: [
      {
    ...
    location_collaborators_number: "+13",
  },
];
